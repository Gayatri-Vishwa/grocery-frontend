...
// import { logeOutUser } from "../../../backend/controllers/user.Controller";
const Navbar = () => {
  const {
    user,
    setUser,
    ...
    logoutUser,
    loginUser,
  } = useContext(AppContext); //sttates from contextapi

  useEffect(() => {
    //when we search it navigate to products page
        ...
        {user ? (
          <>
            ...
            <div className="relative group">
              ...
              />
              {menuOpen && (
                <ul className="absolute top-10 right-0 bg-white shadow-md p-2 w-30 border border-gray-200 rounded-md z-40 text-sm">
                  <li
