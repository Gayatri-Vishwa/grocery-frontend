...
function Hero() {
  ...
  return (
    ...
    <h1 className='text-3xl md:text-4xl font-bold md:text-left text-center max-w-72 md:max-w-80  leading-tight lg:leading-15'>
    ...
    <div className='flex items-center mt-6 font-medium gap-6'> 
        ...
        Shop Now
        <img src={assets.white_arrow_icon} alt="" className='md:hidden transition group-focus:translate-1 text-white'/>
        </Link>
